...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FlxDaedalus", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("FlxDaedalus", null, 1024, 768);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "FlxDaedalus";
		app.meta["name"] = "FlxDaedalus";
